...
public class JsonCodecFactoryConcurrencyTest {
    public final JsonCodecFactory factory = JsonCodecFactory.getInstance();
    ...
    public void shouldHandleConcurrentAccess() throws Exception {
        ...
        for (int j = 0; j < numTries; ++j) {
            ...
            for (int i = 0; i < numThreads; ++i) {
                runnables.add(() -> {
                    factory.clear();
                    JsonCodec result = factory.getCodec(getRandomStrategy());
